...
namespace Foody
{
    ...
    public class FoodyTests
    {
        ...
        [Test, Order(2)]
        public void EditFood_ShouldReturnCreated()
        {
            var changes = new[]
            {
        ...
        public void GetAllFoods_ReturnList()
        {
            ...
            var food = JsonSerializer.Deserialize<List<object>> (response.Content);
            Assert.That(food, Is.Not.Empty);
        }


        [Test, Order(4)]
        public void DeleteFood_ReturnSuccess()
        { 
